...
(function mozPrintCallbackPolyfillClosure() {
  ...
  window.print = function print() {
	  console.log("  window.print = function print()")
    if (canvases) {
...
var PDFView = {
  ...
  open: function pdfViewOpen(url, scale, password,
	...
	console.log("pdfViewOpen");
	console.log(url);

    if (this.pdfDocument) {
      // Reload the preferences if a document was previously opened.
	  console.log("Preferences.reload()");
      Preferences.reload();
    }
    this.close();
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
	...
	console.log("beforePrint2");
  },

  afterPrint: function pdfViewSetupAfterPrint() {
	 console.log("afterPrint1");
...
window.addEventListener('change', function webViewerChange(evt) {
	console.log("window.addEventListener change")
...
window.addEventListener('localized', function localized(evt) {
  ...
  PDFView.animationStartedPromise.then(function() {
    ...
    // Set the 'max-height' CSS property of the secondary toolbar.
    SecondaryToolbar.setMaxHeight(PDFView.container);
	console.log("PDFView.animationStartedPromise");
  });
}, true);
...
window.addEventListener('beforeprint', function beforePrint(evt) {
	console.log("window.addEventListener beforeprint");
  PDFView.beforePrint();
});

window.addEventListener('afterprint', function afterPrint(evt) {
	console.log("window.addEventListener afterprint");
  PDFView.afterPrint();
});
